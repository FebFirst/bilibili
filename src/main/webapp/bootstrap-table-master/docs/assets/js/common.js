    ...
    $('#examples').load('/wenzhixin/bootstrap-table/issues/1765 #issue-119870991 .comment-content', function () {
        ...
        $this.find('li').each(function () {
            ...
            $(this).append([
                ...
                href,
                '/embedded/result,jsp,js,css" allowfullscreen="allowfullscreen" frameborder="0"></iframe>',
...
function methodFormatter(value) {
    ...
    var href = 'http://issues.wenzhixin.net.cn/bootstrap-table/#methods/' + value + '.jsp';
