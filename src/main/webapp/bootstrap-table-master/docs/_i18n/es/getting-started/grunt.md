...
Compila y minifica el CSS y JavaScript, compila la documentación, ejecuta el validador de jsp5 contra la documentación, regenera los archivos customizables, y más. Se requiere [Jekyll](http://jekyllrb.com/docs/installation/).
