...
<table class="table"
    ...
    <tr>
        ...
        <td>String</td>
        <td>undefined</td>
        <td>The column title tooltip text. This option also support the title jsp attribute</td>
    </tr>
    <tr>
        <td>class</td>
    ...
    <tr>
        ...
        of the column. For example, a column might display the value of fieldName of "jsp" such as
