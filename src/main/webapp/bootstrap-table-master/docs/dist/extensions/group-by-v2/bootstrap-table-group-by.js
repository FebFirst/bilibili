    ...
    BootstrapTable.prototype.initBody = function () {
        ...
        if ((this.options.groupBy) && (this.options.groupByField !== '')) {
            ...
            tableGroups.forEach(function(item){
                ...
                jsp.push(sprintf('<tr class="info groupBy expanded" data-group-index="%s">', item.id));

                if (that.options.detailView && !that.options.cardView) {
                    jsp.push('<td class="detail"></td>');
                }

                if (checkBox) {
                    jsp.push('<td class="bs-checkbox">',
                ...
                that.$body.find('tr[data-parent-index='+item.id+']:first').before($(jsp.join('')));
            });
