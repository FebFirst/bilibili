		...
		function submit_report_comment()
		{
			...
			$.ajax({
				...
				success: function () {
					...
					jq('#success_modal').modal("show");
					setTimeout(function(){jq("#success_modal").modal("hide")},1000);

				},
				error: function (XMLHttpRequest, textStatus, errorThrown) {
					document.getElementById("modal_text").innerHTML='您只能举报一次'
					jq('#success_modal').modal("show");
					setTimeout(function(){jq("#success_modal").modal("hide")},1500);
				}
			});
		...
		function submit_report_reply()
		{
			...
			$.ajax({
				...
				error: function (XMLHttpRequest, textStatus, errorThrown) {
					...
					jq('#success_modal').modal("show");
					setTimeout(function(){jq("#success_modal").modal("hide")},2000);
				}
			});
					...
					<div class="wrap-vid">
						<div class="barrage">
							<div class="barrage-content">
								...
								<ul>
									<label style="margin-left: -62%">弹幕颜色：</label>
									<input type="color" id="mycolor" value="#92cddc" style="width: 4%;">
								</ul>
								<ul>
									<label style="margin-left: -54%">弹幕类型：</label>
								...
								<ul>
									<label style="margin-left: -3%">屏蔽设定：</label>
			...
			<div class="modal-content">
				...
				<div id="report_reason">
					<div class="modal-body" style="padding-left: 2%" >
						...
						<p><textarea  id="report_main_reason" name="reason" placeholder="在这里写出你的理由..." required ></textarea></p>
					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-default"
								data-dismiss="modal">关闭
			...
			<div class="modal-content">
				...
				<div>
					<div class="modal-body" style="padding-left: 2%" >
						...
						<p><textarea  id="report_main_reason_2" name="reason" placeholder="在这里写出你的理由..." required ></textarea></p>
					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-default"
								data-dismiss="modal">关闭
...
//			alert("SUCCESS");
	...
	function fetch(){
		...
		jq.ajax({
			...
			type : "POST",
			data : "videoId=" + document.getElementById("videoId").value,//document.getElementById("videoId"),
			dataType: "json",
