						...
						<div class="barrage">
							<div class="barrage-content">
								...
								<ul>
									...
									<input id="mycolor" value="#92cddc" style="width: 40%;">
								</ul>
								<ul>
									<label>弹幕类型：</label>
...
//			alert("SUCCESS");
		...
		function fetch(){
			...
			jq.ajax({
				...
				type : "POST",
				data : "videoId=" + 1,//document.getElementById("videoId"),
				dataType: "json",
				success:function(data){
					if (data) {
						var timeline = JSON.parse(data.barrageJson);
